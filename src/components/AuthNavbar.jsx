        ...
        <div className="flex justify-between items-center h-16">
          ...
          >
            <div className="relative">
              <div className="w-10 h-10 rounded-2xl flex items-center justify-center shadow-lg shadow-blue-500/25 overflow-hidden">
              ...
              <>
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    <div 
                      className={`w-8 h-8 rounded-full border-2 border-gray-200 bg-blue-600 flex items-center justify-center ${user.photoURL ? 'hidden' : 'flex'}`}
                    >
